...
export async function buildStaticApp() {
  ...
  await Promise.all([
    ...
    cp(path.join(SRC_DIR, "renderer/leadDetailRenderer.js"), path.join(DIST_SRC_DIR, "renderer/leadDetailRenderer.js")),
    cp(path.join(SRC_DIR, "renderer/verificationRenderer.js"), path.join(DIST_SRC_DIR, "renderer/verificationRenderer.js")),
    cp(path.join(SRC_DIR, "renderer/renderUtils.js"), path.join(DIST_SRC_DIR, "renderer/renderUtils.js")),
