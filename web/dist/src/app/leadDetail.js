...
export const mockLeadDetails = {
  ...
  lead_school_002: {
    ...
    summary: {
      ...
      score: 82,
      timing: "this week",
      roomNightSignal: "98 room nights",
      propertyFit: "extended stay"
    },
    sourceEvidence: {
      sourceName: "Bend planning portal",
      sourceUrl: "https://permits.example.test/bend/roof-204",
      rawAuditHref: "/api/leads/lead_school_002/raw",
      collectedAt: "2026-05-05T11:00:00Z"
    },
    aiEnrichment: {
      rationale:
        "Planning record describes a two-week school roof replacement with a mid-size subcontractor crew.",
      uncertainty: {
        level: "low",
        reason: "Project type and schedule are directly present in the planning record."
      },
      claims: [
        {
          field: "Project type",
    ...
    outreach: {
      recommendedTiming: "Follow up this week with the facilities coordinator.",
      contact: {
        channel: "email",
        value: "facilities@riverside-school.example"
      },
      draft:
        "Riverside school roof replacement: GroupScout can source extended-stay rooms for roofing crews during the two-week project window.",
      attempts: [
        {
          channel: "email",
          label: "Owner claimed lead",
          contact: "facilities@riverside-school.example",
          notes: "Sam Rivera claimed the lead for manual follow-up.",
          outcome: "queued",
    ...
    activity: [
      {
        type: "status_history",
        label: "Lead created",
        detail: "Claimed lead created from planning portal ingestion.",
        timestamp: "2026-05-05T11:00:00Z"
      },
      {
        type: "assignment",
        label: "Owner assigned",
        detail: "Sam Rivera claimed the lead.",
        timestamp: "2026-05-05T12:20:00Z"
      }
    ]
  },
  lead_multifamily_003: {
    ...
    summary: {
      ...
      score: 74,
      timing: "tomorrow",
      roomNightSignal: "50 room nights",
      propertyFit: "multifamily"
    },
    sourceEvidence: {
      sourceName: "Builder network",
      sourceUrl: "https://builder.example.test/tacoma/exterior-paint-33",
      rawAuditHref: "/api/leads/lead_multifamily_003/raw",
      collectedAt: "2026-05-03T09:30:00Z"
    },
    aiEnrichment: {
      rationale:
        "Builder network post mentions a 10-day exterior paint project with a small travelling crew.",
      uncertainty: {
        level: "medium",
        reason: "Crew travel need is inferred from the contractor location and should be verified."
      },
      claims: [
        {
          field: "Project type",
    ...
    outreach: {
      recommendedTiming: "Check back tomorrow after the initial notification.",
      contact: {
        channel: "email",
        value: "dana.lee@example.test"
      },
      draft:
        "Eastside multifamily exterior paint: GroupScout can help place a small paint crew near the Tacoma project site.",
      attempts: [
        {
          channel: "slack",
          label: "Slack notification sent",
          contact: "#groupscout-leads",
          notes: "Lead was included in the notified digest.",
          outcome: "notified",
    ...
    activity: [
      {
        type: "status_history",
        label: "Lead created",
        detail: "New lead created from builder network ingestion.",
        timestamp: "2026-05-03T09:30:00Z"
      },
      {
        type: "outreach_attempt",
        label: "Slack notification sent",
        detail: "Lead was included in the notified digest.",
        timestamp: "2026-05-03T10:15:00Z"
      }
    ]
  }
